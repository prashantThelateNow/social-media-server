...
const globalErrorHandler = (err, req, res, next) => {
    ...
    if(err) {
        let apiResponse = generate(true, 'Some error occured at global level',500, null)
...
const globalNotFoundHandler = (req, res, next) => {
    ...
    let apiResponse = generate(true, `${req.originalUrl} path doesn't exists in application`,404, null);
